...
::: {.callout-note}
La solución se desarrollará utilizando **Visual Studio Code** como editor de texto, en un sistema operativo **Windows**. Si prefieres otro editor o sistema operativo, los pasos generales seguirán siendo los mismos.
:::
